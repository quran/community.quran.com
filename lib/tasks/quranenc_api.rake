namespace :quranenc_api do
  ...
  task import: :environment do
    ...
    resource_content_mapping = {
        ...
        french_montada: {language: 49, author_name: 'Montada Islamic Foundation', id: 136},
        ...
        english_hilali_khan: {language: 38, author_name: 'Muhammad Taqi-ud-Din al-Hilali & Muhammad Muhsin Khan', id: 203},
        indonesian_sabiq: {language: 33, author_name: 'The Sabiq company', id: 141},
        english_rwwad: {language: 38, author_name: 'Ruwwad Center', id: 206},
        english_irving: {language: 38, author_name: "Muhammad Hijab", id: 207},
        german_aburida: {language: 33, author_name: "Abu Reda Muhammad ibn Ahmad", id: 208},
        italian_rwwad: {language: 74, author_name: "Othman al-Sharif", id: 209},
        turkish_rwwad: {language: 167, author_name: "Dar Al-Salam Center", id: 210},
        tagalog_rwwad: {language: 164, author_name: "Dar Al-Salam Center", id: 211},

        # only first 6 surah are available
        # georgian_rwwad: {language: 78, author_name: "Ruwwad Center"},
        bengali_zakaria: {language: 20, author_name: "Dr. Abu Bakr Muhammad Zakaria", id: 213},
        bosnian_rwwad: {language: 23, author_name: "Dar Al-Salam Center", id: 214},
        serbian_rwwad: {language: 152, author_name: "Dar Al-Salam Center", id: 215},
        # disable this, has some missing ayah(3:154)
        # albanian_rwwad: {language: 187, author_name: "Ruwwad Center", id: 216 },
        ukrainian_yakubovych: {language: 173, author_name: "Dr. Mikhailo Yaqubovic", id: 217},
        japanese_saeedsato: {language: 76, author_name: "Saeed Sato", id: 218},
        korean_hamid: {language: 86, author_name: "Hamed Choi", id: 219},
        vietnamese_rwwad: {language: 177, author_name: "Ruwwad Center", id: 220 },
        vietnamese_hassan: {language: 177, author_name: "Hasan Abdul-Karim", id: 221},
        kazakh_altai: {language: 82, author_name: "Khalifa Altay", id: 222},
        tajik_arifi: {language: 160, author_name: "Pioneers of Translation Center", id: 223},
        malayalam_kunhi: {language: 106, author_name: "Abdul-Hamid Haidar & Kanhi Muhammad", id: 224},
        gujarati_omari: {language: 56, author_name: "Rabila Al-Umry", id: 225},
        marathi_ansari: {language: 108, author_name: "Muhammad Shafi’i Ansari", id: 226},
        telugu_muhammad: {language: 159, author_name: "Maulana Abder-Rahim ibn Muhammad", id: 227},
        sinhalese_mahir: {language: 145, author_name: "Ruwwad Center", id: 228},
        tamil_omar: {language: 158, author_name: "Sheikh Omar Sharif bin Abdul Salam", id: 229},
        thai_complex: {language: 161, author_name: "Society of Institutes and Universities", id: 230},
        swahili_abubakr: {language: 157, author_name: "Dr. Abdullah Muhammad Abu Bakr and Sheikh Nasir Khamis", id: 231},
        luganda_foundation: {language: 95, author_name: "African Development Foundation", id: 232},
        hebrew_darussalam: {language: 59, author_name: "Dar Al-Salam Center", id: 233}
    }
